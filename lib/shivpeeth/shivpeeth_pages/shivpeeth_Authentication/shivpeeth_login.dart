...
Future login(String username, String password) async {
  ...
  Widget build(BuildContext context) {
    ...
    body: Container(
      ...
      child: Column(
        children: [
         SizedBox(height: height * 0.05), // Adjusted based on screen height

               Flexible(
                    flex: isPortrait ? 2 :1, // Adjust flex based on orientation
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Center(
                            child: Container(
                             width: isPortrait ? 180 : 120, // Adjusted width based on orientation
                            height: isPortrait ? 180 : 120, // Adjusted height based on orientation
           ...
           Expanded(
           flex: isPortrait ? 3 : 3, // Adjust flex based on orientation
            child: Container (
            decoration: BoxDecoration (
            color: Colors.white,
 ...
 SizedBox(height: 40,),
  ...
  child: Container(
    ...
    child: Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween, // Ensure contents are spaced evenly
        children: [
          Expanded(
